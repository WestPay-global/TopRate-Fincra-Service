...
{
    public class MobileMoneyWalletProcessor : IPayoutProcessor
    {

        private readonly IHttpDataClient _httpDataClient;
        private readonly IMapper _mapper;
        private readonly IConfiguration _configuration;
        public MobileMoneyWalletProcessor(IHttpDataClient httpDataClient, IMapper mapper, IConfiguration configuration)
        {
        ...
        public async Task<PayoutResponse> Process(PayoutRequest payout, Models.Dtos.Request.Beneficiary beneficiary)
        {
            ...
            payout.Beneficiary = _mapper.Map<MobileMoneyBeneficiary>(beneficiary);
